...
# 1. There is no confirmation of a successful booking.
# 2. There is nothing to prevent more than one bookings
# 3. There is no place for user input, the client cannot interact with this
# 4. There are no security considerations
# 5. There is no way to cancel or re-book an apointment
